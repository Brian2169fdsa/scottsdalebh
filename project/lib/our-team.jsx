/* global React, PageShell, SectionHeading, Slot, Ico, CtaBand, Badge */
  ...
  return (
    <section className="sbhg-section" style={{ background: 'var(--cream-50)' }}>
      <div className="sbhg-container">
        ...
        <p style={{ textAlign: 'center', marginTop: 32, fontFamily: 'var(--font-body)', fontSize: 13, color: 'var(--gray-600)' }}>[NEEDS-CLIENT] Replace with SBHG's real staff: headshots, names, credentials, titles &amp; bios.</p>
      </div>
    </section>
  );
}
...
function TeamPage() {
  return (
    <PageShell active="Our Team" hero={{
      ...
      <TeamIntro />
      <TeamGrid />
      <CtaBand title="Want to meet the team?" body="The best way to know if we're the right fit is to talk. Reach out and we'll set up a conversation — no pressure, complete confidentiality." primary="Verify Insurance" secondary="Contact Us" secondaryHref="contact.html" />
    </PageShell>
  );
}
