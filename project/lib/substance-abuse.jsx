/* global React, PageShell, CtaStrip, SplitFeature, ChipGrid, ModalitiesGrid, CtaBand,
   Testimonials, InsuranceWall, SectionHeading, Slot, Ico, Button, IconCircle */

const SA_SUBS = [
  ['Alcohol', 'Medically supported withdrawal and a path beyond cravings.'],
  ['Opioids', 'MAT-informed care for prescription and illicit opioid dependence.'],
  ['Methamphetamine', 'Stimulant-specific recovery with cognitive and mood support.'],
  ['Cocaine', 'Breaking the cycle with structure, therapy, and community.'],
  ['Benzodiazepines', 'Careful, physician-guided tapering and stabilization.'],
  ['Marijuana', 'Support for dependence that has started to cost you more than it gives.'],
].map(([l, d]) => [l, d, '#substances']);
...
function SubstancePage() {
  return (
    <PageShell active="Substance Abuse" hero={{
      ...
      <SplitFeature
        ...
        cta="See Our Programs" ctaHref="programs.html#detox" slotId="sa-detox" tone="calm" flip bg="var(--white)" />
      <SplitFeature
        ...
        cta="Explore Levels of Care" ctaHref="programs.html" slotId="sa-extended" tone="sand" bg="var(--cream-50)" />
      <Alumni />
      <SplitFeature
        ...
        cta="Family Therapy" ctaHref="programs.html#family" slotId="sa-family" tone="dusk" flip bg="var(--white)" />
