/* global React, PageShell, CtaStrip, InsuranceWall, FaqAccordion, SectionHeading,
   Slot, Ico, Button, IconCircle, SplitFeature */
...
function InsurancePage() {
  return (
    <PageShell active="Insurance" hero={{
      ...
      <SplitFeature
        ...
        cta="Talk to Admissions" ctaHref="contact.html" slotId="ins-private" tone="sand" bg="var(--white)" />
