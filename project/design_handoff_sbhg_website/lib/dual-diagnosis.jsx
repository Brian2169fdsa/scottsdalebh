/* global React, PageShell, CtaStrip, SplitFeature, ChipGrid, ModalitiesGrid,
   InsuranceWall, SectionHeading, Slot, Ico, IconCircle, Button, Badge */
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 28, marginTop: 48 }}>
          {steps.map(([num, icon, title, body]) => (
            <div key={num} style={{ position: 'relative', background: 'var(--cream-50)', border: '1px solid var(--gray-200)', borderRadius: 'var(--radius-card)', padding: '40px 36px', boxShadow: 'var(--shadow-soft)' }}>
              ...
              <span style={{ width: 60, height: 60, borderRadius: '50%', border: '1.5px solid var(--gold-500)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', color: 'var(--gold-700)', marginBottom: 20 }}><Ico name={icon} size={26} c="var(--gold-700)" /></span>
    ...
    <section style={{ position: 'relative', background: 'var(--navy-800)', padding: '92px 0', overflow: 'hidden' }}>
      <div className="sbhg-container" style={{ position: 'relative', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 22 }}>
        ...
        <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', justifyContent: 'center', marginTop: 8 }}>
          <Button variant="primary" size="lg" href="substance-abuse.html">Substance Recovery</Button>
          <Button variant="secondary-dark" size="lg" href="mental-health.html">Mental Health Care</Button>
        </div>
      </div>
    </section>
  );
      ...
      <div className="sbhg-container" style={{ maxWidth: 860, margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12 }}>
          ...
          <span style={{ textAlign: 'left' }}>
            ...
            <span style={{ display: 'block', fontFamily: 'var(--font-body)', fontSize: 13.5, color: 'var(--gray-600)' }}>Alumni, 2024 · [NEEDS-CLIENT]</span>
          </span>
        </div>
      </div>
    </section>
...
function DualPage() {
  return (
    <PageShell active="Dual Diagnosis" hero={{
